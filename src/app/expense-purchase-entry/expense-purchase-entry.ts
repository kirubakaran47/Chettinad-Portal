...
@Component({
  selector: 'app-expense-purchase-entry',
  imports: [CommonModule, RouterModule, FormsModule, ReactiveFormsModule, NgSelectModule, MatTooltipModule],
  templateUrl: './expense-purchase-entry.html',
  styleUrl: './expense-purchase-entry.css'
})
export class ExpensePurchaseEntry implements OnInit {
  ...
  addPurchaseEntryModal() {
    ...
    this.router.navigate(['/expensePurchaseEntryAdd']);
  }
  editPurchaseEntryModal(purchaseEntryID: any) {

    this.router.navigate(['/expensePurchaseEntryEdit'], {
